...
import de.kleindev.twitchbot.fxmlcontrollers.debug.Debug_2FA;
...
import de.kleindev.twitchbot.websocket.packets.auth.InvalidTwoFATokenPacket;
...
public class WSClient extends WebSocketClient {
    ...
    public void onMessage(String message) {
        ...
        if (packet instanceof ArgonIterationPacket){
            ArgonManager.iterations = ((ArgonIterationPacket)packet).getIterations();
            return;
        }
